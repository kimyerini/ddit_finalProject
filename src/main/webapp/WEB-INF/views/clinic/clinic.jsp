			...
			<script type="text/javascript">
				...
				var gr4 = `
				   		...
				   		<div id="one" style="display: flex; align-items: flex-start;"> 
					   	    ...
					   	    <div style="text-align: left; align-items: center; margin-top: 15px; margin-right: 15px; margin-left: 20px;"> 
					   	    ...
					   	    <div style="text-align: center; align-items: center; margin-top: 13px; margin-left: 33px;">
              ...
              <div class="tab-pane fade show active" id="inspcection" role="tabpanel">
		      	<div style="display:flex; margin:10px;">
		            ...
		            <div>
			           ...
			           <button type="button" class="btn btn-warning me-3" onclick=" getEndInspcList()">결과</button>
