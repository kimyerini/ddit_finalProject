          ...
          <div>
              <h5 class="pb-2 border-bottom mb-1" style="text-align:left; margin-right:120px; font-weight: bold;">침상배정 </h5>
                ...
                <div>
                  ...
                  <div id="bedDiv" style="width: 270px;"> 
            ...
            <div style="margin-top : 30px;">
               ...
               <div  style="display:flex; float:right; ">
                   <div>
                      <button id="pTempBtn" class="btn btn-xs btn-info" style="margin-right : -90%; margin-left : 60px; margin-top : 50px;">임시저장</button>
                   </div>
                   <div>
                      <button onclick="pEndBtn()" id="pEndBtn" class="btn btn-xs btn-secondary" style="margin-right: -190%;margin-top : 50px;" >치료완료</button>
                   </div>
               </div>
