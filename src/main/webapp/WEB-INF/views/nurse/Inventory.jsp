...
<script type="text/javascript">
	...
	let gridStack1 = `<div id="inventory" style=" height:97%; padding:0px;overflow: clip;">
      <h5 class="card-header" style="margin:10px 0px 0px 20px;">재고 현황</h5>
     ...
     let gridStack2 = `<div id="div2" style="width:100%; height:100%; padding:10px;">
						 ...
						 <div class="form-group">
						  ...
						  <div class="form-group">
							...
							<button type="button" style="margin-top:20px; float:right;" class="btn btn-primary" id="apcBtn">확인</button><br><br>

		
						<div id="dd" style="background-color:white;text-align: left; margin-top: 20px;">
						...
						<label class="form-check-label" style="display: flex; align-items: center;">
						  ...
						  <span style="margin-top: 10px;">전체선택</span>
						</label>
						
						<div class="card" style="width: 100%; margin:30px 0px 30px 0px;">
						  <div class="table-responsive text-nowrap">
							...
							<button type="button" style="margin-top:20px; float:right;"class="btn btn-secondary" id="cancelBtn">삭제</button>
