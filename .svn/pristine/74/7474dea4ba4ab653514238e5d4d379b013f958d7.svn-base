...
<div class="modal-content" id="filmingModal" style="width: 500px;">
    <div class="modal-header" style="padding-top: 15px;">
        <h4 class="modal-title" style="margin-left:2px; margin-top:2px;">파일 업로드</h4>
        <input class="form-control" type="file" id="fileInput" multiple style="width: 60%; position: absolute; bottom:449px; right: -10px; margin-right:35px;">
...
<!--         <button type="button" id="closeModal" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button> -->
    ...
    <div class="modal-body" style="margin-bottom: 3px; padding-top: 5px; padding-bottom: 5px;">
        ...
        <div class="row mb-1" style="margin-top:5px;">
            ...
            <table id="a"class="table table-bordered" style="text-align: center;">
    ...
    <div class="modal-footer" style="padding-bottom: 10px;">
        ...
        <button class="btn btn-primary" id="submit" style="position: absolute; bottom: 0; right: 0; margin-right:20px; margin-bottom:20px;">등록</button>
    </div>
</div>
